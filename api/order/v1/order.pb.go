...
const file_api_order_v1_order_proto_rawDesc = "" +
	"\n" +
	"\x18api/order/v1/order.proto\x12\fapi.order.v1\x1a\x1cgoogle/api/annotations.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xa9\x01\n" +
	"\tOrderItem\x12\x1d\n" +
	"\n" +
	...
	"\n" +
	"unit_price\x18\x05 \x01(\tR\tunitPrice\"\xd6\x02\n" +
	"\tOrderInfo\x12\x0e\n" +
