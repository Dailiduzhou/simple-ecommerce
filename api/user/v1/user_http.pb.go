...
func RegisterUserHTTPServer(s *http.Server, srv UserHTTPServer) {
	r := s.Route("/")
	r.POST("/v1/users/me/browsing-history", _User_RecordProductView0_HTTP_Handler(srv))
	r.GET("/v1/users/me/browsing-history", _User_ListBrowsingHistory0_HTTP_Handler(srv))
	r.DELETE("/v1/users/me/browsing-history/{product_id}", _User_DeleteBrowsingHistoryItem0_HTTP_Handler(srv))
	r.DELETE("/v1/users/me/browsing-history", _User_ClearBrowsingHistory0_HTTP_Handler(srv))
...
func _User_RecordProductView0_HTTP_Handler(srv UserHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		var in RecordProductViewRequest
		...
		http.SetOperation(ctx, OperationUserRecordProductView)
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
			return srv.RecordProductView(ctx, req.(*RecordProductViewRequest))
		})
		out, err := h(ctx, &in)
		if err != nil {
			return err
		}
		reply := out.(*RecordProductViewReply)
		return ctx.Result(200, reply)
	}
}

func _User_ListBrowsingHistory0_HTTP_Handler(srv UserHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		var in ListBrowsingHistoryRequest
		if err := ctx.BindQuery(&in); err != nil {
			return err
		}
		http.SetOperation(ctx, OperationUserListBrowsingHistory)
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
			return srv.ListBrowsingHistory(ctx, req.(*ListBrowsingHistoryRequest))
		})
		out, err := h(ctx, &in)
		if err != nil {
			return err
		}
		reply := out.(*ListBrowsingHistoryReply)
		return ctx.Result(200, reply)
	}
}

func _User_DeleteBrowsingHistoryItem0_HTTP_Handler(srv UserHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		var in DeleteBrowsingHistoryItemRequest
		if err := ctx.BindQuery(&in); err != nil {
			return err
		}
		...
		http.SetOperation(ctx, OperationUserDeleteBrowsingHistoryItem)
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
			return srv.DeleteBrowsingHistoryItem(ctx, req.(*DeleteBrowsingHistoryItemRequest))
		})
		out, err := h(ctx, &in)
		if err != nil {
			return err
		}
		reply := out.(*DeleteBrowsingHistoryItemReply)
		return ctx.Result(200, reply)
	}
}

func _User_ClearBrowsingHistory0_HTTP_Handler(srv UserHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		var in ClearBrowsingHistoryRequest
		if err := ctx.BindQuery(&in); err != nil {
			return err
		}
		http.SetOperation(ctx, OperationUserClearBrowsingHistory)
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
			return srv.ClearBrowsingHistory(ctx, req.(*ClearBrowsingHistoryRequest))
		})
		out, err := h(ctx, &in)
		if err != nil {
			return err
		}
		reply := out.(*ClearBrowsingHistoryReply)
		return ctx.Result(200, reply)
	}
}
...
func (c *UserHTTPClientImpl) ClearBrowsingHistory(ctx context.Context, in *ClearBrowsingHistoryRequest, opts ...http.CallOption) (*ClearBrowsingHistoryReply, error) {
	var out ClearBrowsingHistoryReply
	pattern := "/v1/users/me/browsing-history"
	path := binding.EncodeURL(pattern, in, true)
	opts = append(opts, http.Operation(OperationUserClearBrowsingHistory))
...
func (c *UserHTTPClientImpl) DeleteBrowsingHistoryItem(ctx context.Context, in *DeleteBrowsingHistoryItemRequest, opts ...http.CallOption) (*DeleteBrowsingHistoryItemReply, error) {
	var out DeleteBrowsingHistoryItemReply
	pattern := "/v1/users/me/browsing-history/{product_id}"
	path := binding.EncodeURL(pattern, in, true)
	opts = append(opts, http.Operation(OperationUserDeleteBrowsingHistoryItem))
	opts = append(opts, http.PathTemplate(pattern))
	err := c.cc.Invoke(ctx, "DELETE", path, nil, &out, opts...)
	if err != nil {
		return nil, err
...
func (c *UserHTTPClientImpl) ListBrowsingHistory(ctx context.Context, in *ListBrowsingHistoryRequest, opts ...http.CallOption) (*ListBrowsingHistoryReply, error) {
	var out ListBrowsingHistoryReply
	pattern := "/v1/users/me/browsing-history"
	path := binding.EncodeURL(pattern, in, true)
	opts = append(opts, http.Operation(OperationUserListBrowsingHistory))
	opts = append(opts, http.PathTemplate(pattern))
	err := c.cc.Invoke(ctx, "GET", path, nil, &out, opts...)
	if err != nil {
		return nil, err
...
func (c *UserHTTPClientImpl) RecordProductView(ctx context.Context, in *RecordProductViewRequest, opts ...http.CallOption) (*RecordProductViewReply, error) {
	var out RecordProductViewReply
	pattern := "/v1/users/me/browsing-history"
	path := binding.EncodeURL(pattern, in, false)
	opts = append(opts, http.Operation(OperationUserRecordProductView))
	opts = append(opts, http.PathTemplate(pattern))
	err := c.cc.Invoke(ctx, "POST", path, in, &out, opts...)
	if err != nil {
		return nil, err
